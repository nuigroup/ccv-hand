...
namespace TUIO {
	...
	/**
		 * Returns a List of all currently active Hands
		 *
		 * @return  a List of all currently active Hands
		 */
	...
	private:
		...
		std::list<long> aliveHandList, handBuffer;
		...
		int maxCursorID;
		std::list<TuioHand*> freeHandList, freeHandBuffer;
		int maxHandID;
