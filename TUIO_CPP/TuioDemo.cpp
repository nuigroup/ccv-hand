...
/*Tuio Hand
*/
void TuioDemo::addTuioHand(TuioHand *thand) {
	
	if (verbose) 
		std::cout << "add hand " << thand->getHandID() << " (" <<  thand->getSessionID() << ") " << thand->getX() << " " << thand->getY() << std::endl;

}

void TuioDemo::updateTuioHand(TuioHand *thand) {

	if (verbose) 	
		std::cout << "set hand " << thand->getHandID() << " (" <<  thand->getSessionID() << ") " << thand->getX() << " " << thand->getY() 
					<< " " << thand->getMotionSpeed() << " " << thand->getMotionAccel() << " " << std::endl;
}

void TuioDemo::removeTuioHand(TuioHand *thand) {
	
	if (verbose)
		std::cout << "del hand " << thand->getHandID() << " (" <<  thand->getSessionID() << ")" << std::endl;
}
